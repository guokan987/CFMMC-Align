...
import model.Contrast_multimodal_align as CTVQA_Swin
...
def train_oie(cfg):
    ...
    model = CTVQA_Swin.CTVQA_Swin(**model_kwargs).to(device)#导入模型
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/sutd-qa_dict_st_swin_bert_mmcl.yml', type=str)
