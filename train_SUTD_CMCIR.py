...
def train_oie(cfg):
    ...
    model = VLCIR.VLCIR(**model_kwargs).to(device)#导入模型
...
def main():
    ...
    if cfg.dataset.name == 'tgif-qa':
        ...
        cfg.dataset.vocab_json = '{}_vocab_bert.json'
        ...
        cfg.dataset.val_question_pt = '{}_test_questions_bert3.pt'#val就是test..
