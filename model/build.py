...
def build_model():
    ...
    checkpoint = torch.load('configs/swin_large_patch4_window7_224_22k.pth',map_location=torch.device('cuda:0'))                   
...
def build_model3d():
    ...
    model = SwinTransformer3D(
                 pretrained= 'configs/swin_base_patch244_window877_kinetics600_22k.pth',
                 pretrained2d=False,
                 patch_size=(2,4,4),
                 in_chans=3,
                 embed_dim=128, #96,
